...
class TicketSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        read_only_fields = ['status', 'registered_date', 'agent', 'priority', 'delivery_date']  # Campos solo editables por el admin.
    
    # Método de validación personalizado si quieres manejar valores por defecto o restricciones adicionales.
    def create(self, validated_data):
